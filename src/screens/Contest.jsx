...
import { CATEGORIES, CATEGORY_SUGGESTIONS, leaderboard } from "../mockData";

// Not: Bu ekran henüz mock veriyle çalışıyor — Faz B'de gerçek oylara bağlanacak.
    ...
    <div>
      ...
      {view === "leaderboard" && (
        <div style={{ padding: "0 14px 90px", maxWidth: 480, margin: "0 auto" }}>
          ...
          {leaderboard.map((r) => (
            <div key={r.rank} style={{ display: "flex", alignItems: "center", gap: 12, background: C.cream, border: `1px solid ${C.line}`, borderRadius: 14, padding: "10px 14px", marginBottom: 8 }}>
              <div style={{ fontFamily: FONT_DISPLAY, fontSize: 14, width: 24, textAlign: "center", color: r.rank === 1 ? C.mustard : C.inkSoft }}>{r.rank}</div>
